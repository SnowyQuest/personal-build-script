...
git clone https://github.com/zorn-trees/android_vendor_xiaomi_zorn -b lineage-23.2 vendor/xiaomi/zorn
git clone https://github.com/zorn-trees/hardware_xiaomi -b bka hardware/xiaomi
